...
| 2026 | 19 Feb–7 Mar: Bahmni **Phase 1 designed** (registration and EMR); Phase 2 lab and pharmacy about to be designed, with the Odoo simplification unresolved. GNU Health: **no phase achieved** — the interface could not be simplified as required, and the platform is on standby. | Two repositories; a Help Center; and, four months later, fourteen handwritten returns. |
