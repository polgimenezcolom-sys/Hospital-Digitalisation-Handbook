...
**2018–2026 · KoboToolbox, then Bahmni (GNU Health attempted) · Current state: Phase 1 designed;
hospital running on paper as of July 2026**
...
**Bed capacity was recorded three ways** — 25, 85 and 100 — across eight years of project documents.
It is **85**: general ward 30, paediatrics 35, maternity 20, as the hospital reports monthly under
its own signature to the Ministry, unchanged from 2019 to 2024 and corroborated through the CHASL
channel. The 25 was the daily census mistaken for the complement; the 100 was a round number adopted
for an early sizing exercise and then repeated.

It took eight years and four cohorts to establish a number that was sitting in a spreadsheet the
hospital had been maintaining the whole time — because no cohort ever recorded where its figure came
from, so no later cohort could check it. That number sets server sizing, switch port counts and UPS
capacity. It is the best illustration in the archive of why
[D-1](../4-Instruments/D1-Data-Capture.md) exists: **write down the source, not just the value.**
...
| 2026 | 19 Feb–7 Mar: Bahmni **Phase 1 designed** (registration and EMR); Phase 2 lab and pharmacy about to be designed, with the Odoo simplification unresolved. GNU Health: **no phase achieved** — the interface simplification Phase 1 requires was not achieved in the time available, and the platform is on standby. | Two repositories; a Help Center; and, four months later, fourteen handwritten returns. |
